...
public class Stock {
    ...
    String _ticker;
    String _name;
    double _closing_price;
    double _daily_dollar_change;
    String _daily_percent_change;
    double _daily_high;
    double _daily_low;
    double _52_week_high;
    double _52_week_low;
    double _pe_ratio;
    int _volume;
    double _50_day_moving_average;
    */
 ...
 // Constructor
    ...
    /*
    public static Stock newStock(Response r) {
        
        Stock s = new Stock();
        
        //Scanner sc = newScanner(line).useDelimiter();
        
        return s = new Stock(
                s._ticker,
                s._closing_price, 
                s._daily_dollar_change, 
                s._daily_percent_change, 
                s._daily_high, 
                s._daily_low,
                s._52_week_high, 
                s._52_week_low, 
