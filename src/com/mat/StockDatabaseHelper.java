...
public class StockDatabaseHelper  extends SQLiteOpenHelper {
    ...
    // Table column names
    private static final String KEY_ID = "stockID";
    private static final String KEY_TICKER = "Ticker";
    private static final String KEY_NAME = "companyName";
    private static final String KEY_CLOSING_PRICE = "closingPrice";
    private static final String KEY_DAILY_DOLLAR_CHANGE = "dailyDollarChange";
    private static final String KEY_DAILY_PERCENT_CHANGE = "dailyPercentChange";
    private static final String KEY_DAILY_HIGH = "dailyHigh";
    private static final String KEY_DAILY_LOW = "dailyLow";
    private static final String KEY_52_WEEK_HIGH = "Week52High";
    private static final String KEY_52_WEEK_LOW = "Week52Low";
    private static final String KEY_PE_RATIO = "peRatio";
    private static final String KEY_VOLUME = "volume";
    private static final String KEY_50_DAY_MOVING_AVERAGE = "movingAverage50Day";
